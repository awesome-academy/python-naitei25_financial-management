        ...
        room_infos.append(
            {
                ...
                "move_in_date": move_in.strftime(DAY_MONTH_YEAR_FORMAT),
                "move_out_date": (
                    move_out.strftime(DAY_MONTH_YEAR_FORMAT) if move_out else "N/A"
                ),
                "status": status,
...
def room_detail(request, room_id):
    ...
    context = {
        ...
        "created_at": room_resident.room.created_at.date().strftime(
            DAY_MONTH_YEAR_FORMAT
        ),
        "move_in_date": move_in.strftime(DAY_MONTH_YEAR_FORMAT),
        "move_out_date": (
...
def room_history(request, room_id):
    ...
    template_name = "resident/rooms/room_history.html"
